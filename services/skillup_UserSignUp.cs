...
public async Task<responseData> VerifyOtp(requestData req)
{
    ...
    try
    {
        ...
        string query = @"SELECT * FROM pc_student.OtpVerification WHERE identifier=@identifier AND otp=@otp AND expiry_time > @current_time";
        MySqlParameter[] myParam = new MySqlParameter[]
        {
            new MySqlParameter("@identifier", identifier),
            new MySqlParameter("@otp", otp),
...
//         {
//             resData.rData["rCode"] = 1;
//             resData.rData["rMessage"] = "Email or phone number and OTP are required";
//             return resData;
//         }
...
//         {
//             resData.rData["rCode"] = 1;
//             resData.rData["rMessage"] = "Invalid OTP or OTP expired";
//         }
//         else
//         {
//             MySqlParameter[] updateParams = new MySqlParameter[]
